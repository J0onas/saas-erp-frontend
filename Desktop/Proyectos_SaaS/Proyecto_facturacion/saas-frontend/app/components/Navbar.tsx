...
// Ítems de navegación con control de roles
// roles: undefined = cualquier usuario autenticado puede ver
const NAV_ITEMS = [
...
export default function Navbar({ cajaInfo }: { cajaInfo?: string }) {
  ...
  useEffect(() => {
    ...
    } catch { /* localStorage vacío o inválido */ }
  }, []);
          ...
          <div className="flex items-center gap-2">
            ...
            {userRole && (
              <div className="hidden sm:flex items-center gap-2">
                {userName && (
                  <span className="text-xs text-slate-500 font-medium max-w-[100px] truncate">
                    {userName}
                  </span>
                )}
